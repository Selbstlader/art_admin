...
type ProjectDocument struct {
	...
	Keywords        string         `gorm:"type:json;default:'[]'" json:"keywords"`                // 提取的关键字(JSON) / Extracted keywords in JSON format
	...
	FunctionalZones string         `gorm:"type:json;default:'[]'" json:"functionalZones"`         // 功能分区(JSON) / Functional zones in JSON format
