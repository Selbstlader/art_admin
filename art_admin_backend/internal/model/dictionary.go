...
type DictionaryType struct {
	...
	TypeName    string         `gorm:"type:varchar(50);not null;index:idx_sys_dictionary_type_type_name,unique" json:"typeName"` // 字典类型名称
	TypeCode    string         `gorm:"type:varchar(50);not null;index:idx_sys_dictionary_type_type_code,unique" json:"typeCode"` // 字典类型编码
