    ...
    <div class="page-content roadbook-list">
      ...
      <div class="list-header">
        <ElRow justify="space-between" :gutter="16" align="middle">
          ...
          <ElCol :lg="6" :md="8" :sm="12" :xs="16">
            <ElInput v-model="searchKeyword" :prefix-icon="Search" clearable placeholder="搜索路书标题或描述"
          ...
          <ElCol :lg="12" :md="10" :sm="0" :xs="0">
            <div class="filter-area">
              ...
              <div class="filter-item">
                ...
                <ElSelect v-model="selectedTagId" placeholder="全部标签" clearable style="width: 150px"
        ...
        <div class="mobile-filter-area">
          <ElRow :gutter="12">
            <ElCol :span="12">
              <ElSelect v-model="selectedTagId" placeholder="全部标签" clearable style="width: 100%"
                @change="handleTagChange">
                <ElOption v-for="tag in tagList" :key="tag.id" :label="tag.name" :value="tag.id" />
              </ElSelect>
            </ElCol>
        ...
        <div v-if="hasActiveFilters" class="active-filters">
          ...
          <ElTag v-if="selectedTagId && selectedTagName" closable size="small" :color="selectedTagColor"
      ...
      <div class="list-content">
        <div class="roadbook-grid">
          <RoadbookCard v-for="item in roadbookList" :key="item.id" :roadbook="item" :loading="loading"
        ...
        <div v-if="loading && roadbookList.length === 0" class="roadbook-grid">
          <RoadbookCard v-for="i in 8" :key="'skeleton-' + i" :roadbook="skeletonRoadbook" :loading="true" />
        </div>
      </div>

      <!-- 分页 -->
      <div class="list-pagination" v-if="total > 0">
        <ElPagination v-model:current-page="currentPage" v-model:page-size="pageSize" :page-sizes="[12, 24, 36, 48]"
          :total="total" :pager-count="7" layout="total, sizes, prev, pager, next, jumper" background
...
const handleCardClick = (roadbook: Roadbook) => {
  router.push({ name: 'RoadbookDetail', params: { id: roadbook.id } })
}
