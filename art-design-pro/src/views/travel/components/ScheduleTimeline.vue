  ...
  <div class="schedule-timeline">
    ...
    <div v-else class="timeline-container">
      ...
      <ElTabs v-model="activeDay" type="card" class="day-tabs">
        <ElTabPane v-for="day in days" :key="day" :label="getDayLabel(day)" :name="String(day)">
          <div class="day-content">
            ...
            <ElTimeline class="waypoint-timeline">
              <ElTimelineItem
                ...
                :hollow="false"
                :size="
                  index === 0 || index === getDayWaypoints(day).length - 1 ? 'large' : 'normal'
                "
              >
                <template #dot>
                  <div
                    class="timeline-dot"
                    :class="getDotClass(index, getDayWaypoints(day).length)"
                  >
                    {{ index + 1 }}
                  </div>
                </template>
                ...
                <div class="timeline-content">
                  <div class="waypoint-card">
                    <div class="card-header">
                      ...
                      <ElTag v-if="waypoint.waypointType === 1" size="small" type="success"
                        >起点</ElTag
                      >
                      <ElTag v-else-if="waypoint.waypointType === 3" size="small" type="danger"
                        >终点</ElTag
                      >
                    </div>
