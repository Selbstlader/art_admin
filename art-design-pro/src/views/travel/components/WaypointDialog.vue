<template>
  <ElDialog v-model="dialogVisible" :title="isEdit ? '编辑途经点' : '添加途经点'" width="700px" :close-on-click-modal="false"
    @close="handleClose">
    <ElForm ref="formRef" :model="formData" :rules="formRules" label-width="80px" label-position="top">
      <!-- 地图选点 -->
      ...
      <ElFormItem label="预算金额" prop="budget">
        <ElInputNumber v-model="formData.budget" :min="0" :precision="2" placeholder="预算金额" style="width: 100%">
      ...
      <ElFormItem label="备注" prop="notes">
        <ElInput v-model="formData.notes" type="textarea" placeholder="添加备注信息" :rows="3" maxlength="500"
          show-word-limit />
      </ElFormItem>
    </ElForm>
