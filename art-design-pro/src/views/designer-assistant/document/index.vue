  ...
  <div class="document-page">
    <el-row :gutter="20">
              ...
              <el-dropdown @command="handleCommand($event, doc)">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item
                      command="analyze"
                      :disabled="doc.analysisStatus === 'processing'"
                    >
                      分析文档
                    </el-dropdown-item>
      ...
      <el-col :span="16">
        <el-row :gutter="20">
          <el-col :span="24">
            <DocumentAnalysis :document="selectedDoc" @analysis-complete="handleAnalysisComplete" />
          </el-col>
          <el-col v-if="analysisResult" :span="24" style="margin-top: 20px">
            <KeywordExtraction :analysis-result="analysisResult" @apply="handleApplyToProject" />
          </el-col>
        </el-row>
      </el-col>
    </el-row>
    ...
    <el-dialog v-model="showUploadDialog" title="上传文档" width="600px">
      <DocumentUpload :project-id="projectId" @upload-success="handleUploadSuccess" />
    </el-dialog>
  </div>
</template>
